...
`dist/cali-typlog-0.8.8.zip`. No Node runtime or separate image account is required. Typlog serves the bundled
...
- Add six native tag categories with year groups and 20-article batches.
- Place Categories before Projects in the dock; remove Zhihu and podcast shortcuts.
- Align category headings with writing and projects, and add a compact archive year selector.
...
- Fill the 2.35:1 article-list frames with centered, proportional cropping for covers of other ratios.
- Preserve the existing frame sizes and article-page styles.
